function Products(options = {}) {
    ...
    this.starImageLink = this.opt.starImageLink;
...
Products.prototype._renderRating = function(product) {
    ...
    cardRating.innerHTML = `
        <img src="${product.starImageLink}" alt="star">
        <p>${product.rating}</p>
    `;
    return cardRating;
}
...
Products.prototype._renderPrevPrice = function (product) {
    ...
    cardPrevPrice.className = 'card-prevprice';
...
Products.prototype._renderQuantityBtns = function (item, quantity) {
...
Products.prototype._renderListCard = function (product) {
    ...
    const cardButton = this._renderCardBtn(
        product,
        `<p>+</p>
        <img src="svg-image/cart-white.svg" alt="cart-icon">`
    );
